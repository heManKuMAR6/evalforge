...
pub fn extract_code_quality_input(trace: &Trace) -> CodeQualityInput {
    CodeQualityInput {
...
pub fn score_code_quality(
    ...
    api_key: &str,
    threshold: f64,
) -> Result<CodeQualityResult, Box<dyn std::error::Error>> {
    let prompt = format!(
        "You are evaluating the quality of code.\n\n\
        Language: {language}\n\n\
        Code:\n{code}\n\n\
        Evaluate: readability, naming, structure, best practices, comments where needed.\n\n\
        Scoring:\n\
        - 1.0: Clean, readable, follows best practices\n\
        - 0.7: Good quality with minor issues\n\
        - 0.5: Functional but messy or hard to read\n\
        - 0.0: Poor quality, confusing, bad practices\n\n\
...
mod tests {
    ...
    #[test]
    fn test_extract_code_quality_no_code() {
